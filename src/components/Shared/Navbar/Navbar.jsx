        ...
        <>
            <nav className="bg-white border-b fixed w-full z-50 ">
                            ...
                            <li key={item.name} className="relative group dropdown-menu">
                                ...
                                {item.subMenu && openDropdown === index && (
                                    <motion.ul
                                        ...
                                        exit={{ opacity: 0, y: -10 }}
                                        className="absolute left-0 mt-2 bg-white shadow-lg py-2 w-40 md:w-44 lg:w-56"
                                    >
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <ul className="space-y-4 px-4 py-6 md:px-8 lg:px-12">
                            {menuItems.map((item, index) => (
                        ...
                        <div className="space-y-4 px-4 py-6 md:px-8 lg:px-12">
